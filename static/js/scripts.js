...
// Navigation
// ─────────────────────────────────────
const AGENT_VIEWS = ["qa", "db", "qb", "audit", "qt"];
...
// Usuário sem gerência cadastrada (ou gerência fora da lista fixa) — não há
// seletor manual de projeto/dataset dentro do QB, então só resta orientar
// a pedir a um administrador para associar a gerência ao perfil.
function _qbShowNoGerenciaGuidance() {
  ...
  if (hintEl) {
    hintEl.textContent =
      "Peça a um administrador para associar sua gerência ao seu perfil de usuário.";
  }
...
// ══════════════════════════════════════════════════════════════════════════
//  Shared project/dataset select helpers (used by Query Builder)
// ══════════════════════════════════════════════════════════════════════════
...
// ── Query Builder — sugestões (compartilhado com gerência picker) ─────────
